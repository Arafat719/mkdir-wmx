export const TUI_COMMANDS = [
  ...
  },
  {
    key: "explain",
    label: "🧠 Explain",
    description: "Explain how the project works: architecture and key flows (auth, API, database).",
    options: ["--json  Output as JSON"],
    run: "explain",
  },
  {
    ...
    options: ["--threshold <n>  Line count threshold (default: 200)", "--json  Output as JSON"],
    run: "refactor",
  },
  {
    key: "security",
    label: "🔒 Security Audit",
    description: "Detect API key leaks, hardcoded passwords, XSS, SQL injection, CORS, and JWT issues.",
    options: ["--json  Output as JSON"],
    run: "security",
  },
  {
  ...
  },
  {
    ...
    description: "Find unused components, hooks, pages, CSS, images, icons, and fonts.",
    options: ["--json  Output as JSON"],
    run: "clean",
  },
  {
  ...
  },
  {
    ...
    options: ["--output <dir>  Output directory (default: .wmx)", "--json  Output as JSON"],
    run: "memory",
  },
  {
    key: "migrate",
    label: "🚚 Migration",
    description: "Detect outdated tech and suggest migration paths (React Router → Next.js, Tailwind v3 → v4, etc.).",
    options: ["--json  Output as JSON"],
    run: "migrate",
  },
  {
    ...
    options: ["--component <name>  Show a single component's chain", "--json  Output as JSON"],
    run: "graph",
  },
  {
    key: "release",
    label: "🚀 Release Assistant",
    description: "Run a pre-deploy checklist: build, tests, SEO, security, performance, and more.",
    options: ["--skip-build", "--skip-tests", "--json  Output as JSON"],
    run: "release",
  },
  {
    key: "brain",
    ...
    options: ["--output <dir>  Output directory (default: .wmx)"],
    run: "brain",
  },
]
